                ...
                <div className="box-body">
                  <table className="table table-borderless">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><Link to="/EditCar"><button type="submit" className="btn btn-primary ">Editar</button></Link></td>
                        <td><button type="submit" className="btn btn-danger pull-right">Eliminar</button></td>
                      </tr>
